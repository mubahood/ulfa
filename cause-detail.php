    ...
    <div class="container">
        <div class="text-center">
            <div style="margin-bottom: 1.5rem;">
                <a href="causes.php" style="color: var(--primary-yellow); text-decoration: none; font-weight: 700; font-size: 0.95rem; letter-spacing: 0.5px; transition: all 0.3s;" onmouseover="this.style.transform='translateX(-5px)'; this.style.color='#fff'" onmouseout="this.style.transform='translateX(0)'; this.style.color='var(--primary-yellow)'">
    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div style="margin-bottom: 3rem; border: 3px solid var(--primary-black); overflow: hidden;">
                ...
                <!-- Impact Section -->
                <div style="border: 3px solid var(--primary-black); padding: 3rem; background: linear-gradient(135deg, rgba(255,193,7,0.08) 0%, rgba(255,193,7,0.03) 100%); margin-bottom: 2rem;">
            ...
            <div class="col-lg-4">
                <div style="position: sticky; top: 100px;">
                    ...
                    <div style="border: 3px solid var(--primary-black); padding: 2.5rem; background: #fff; margin-bottom: 2rem; box-shadow: 0 4px 0 var(--primary-black);">
                        <div style="margin-bottom: 2rem;">
                            ...
                            <div class="progress" style="height: 18px; background: #e9ecef; border: 3px solid var(--primary-black); margin-bottom: 1.5rem; overflow: hidden;">
                        ...
                        <div style="text-align: center; color: #666; font-size: 0.875rem; font-weight: 600;">
                            <i class="fas fa-shield-alt" style="color: var(--primary-yellow); margin-right: 0.35rem;"></i> Secure donation processing
                        </div>
                        <?php else: ?>
                    ...
                    <!-- Share Card -->
                    <div style="border: 3px solid var(--primary-black); padding: 2.5rem; background: linear-gradient(135deg, rgba(255,193,7,0.08) 0%, rgba(255,193,7,0.03) 100%);">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem;">
                            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']); ?>" target="_blank" style="display: flex; align-items: center; justify-content: center; height: 50px; border: 3px solid var(--primary-black); background: #fff; color: var(--primary-black); text-decoration: none; font-weight: 700; font-size: 0.875rem; transition: all 0.3s;" onmouseover="this.style.background='var(--primary-black)'; this.style.color='#fff'" onmouseout="this.style.background='#fff'; this.style.color='var(--primary-black)'">
                                <i class="fab fa-facebook-f" style="margin-right: 0.5rem;"></i> Share
                            </a>
                            <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']); ?>&text=<?php echo urlencode('Support: ' . $cause['title']); ?>" target="_blank" style="display: flex; align-items: center; justify-content: center; height: 50px; border: 3px solid var(--primary-black); background: #fff; color: var(--primary-black); text-decoration: none; font-weight: 700; font-size: 0.875rem; transition: all 0.3s;" onmouseover="this.style.background='var(--primary-black)'; this.style.color='#fff'" onmouseout="this.style.background='#fff'; this.style.color='var(--primary-black)'">
                                <i class="fab fa-twitter" style="margin-right: 0.5rem;"></i> Tweet
                            </a>
                            <a href="whatsapp://send?text=<?php echo urlencode('Support this cause: ' . $cause['title'] . ' - ' . 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']); ?>" style="grid-column: 1 / -1; display: flex; align-items: center; justify-content: center; height: 50px; border: 3px solid var(--primary-black); background: #fff; color: var(--primary-black); text-decoration: none; font-weight: 700; font-size: 0.875rem; transition: all 0.3s;" onmouseover="this.style.background='var(--primary-black)'; this.style.color='#fff'" onmouseout="this.style.background='#fff'; this.style.color='var(--primary-black)'">
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div style="border: 3px solid var(--primary-black); overflow: hidden; height: 100%; display: flex; flex-direction: column; background: #fff; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='8px 8px 0 var(--primary-yellow)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
                    ...
                    <div style="padding: 2rem; flex: 1; display: flex; flex-direction: column;">
                        ...
                        <div style="margin-bottom: 1.5rem;">
                            <div class="progress" style="height: 12px; background: #e9ecef; border: 2px solid var(--primary-black); margin-bottom: 1rem;">
