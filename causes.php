...
<section style="padding: 2rem 0; background: #f8f9fa; border-bottom: 2px solid var(--primary-black);">
    <div class="container">
        <div class="d-flex justify-content-center gap-3">
            <a href="causes.php?filter=active" class="btn" style="border: 2px solid var(--primary-black); background: <?php echo $filter === 'active' ? 'var(--primary-yellow)' : 'transparent'; ?>; color: var(--primary-black); padding: 0.75rem 2rem; font-weight: 600; text-decoration: none;">
                <i class="fas fa-hand-holding-heart me-2"></i> Active Causes
            </a>
            <a href="causes.php?filter=completed" class="btn" style="border: 2px solid var(--primary-black); background: <?php echo $filter === 'completed' ? 'var(--primary-yellow)' : 'transparent'; ?>; color: var(--primary-black); padding: 0.75rem 2rem; font-weight: 600; text-decoration: none;">
        ...
        <?php else: ?>
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="cause-card" style="border: 2px solid var(--primary-black); border-radius: 0; overflow: hidden; height: 100%; display: flex; flex-direction: column; background: #fff; position: relative; transition: transform 0.3s;">
                        <?php if ($cause['is_featured']): ?>
                        <div style="position: absolute; top: 1rem; right: 1rem; z-index: 10; background: var(--primary-yellow); color: var(--primary-black); padding: 0.5rem 1rem; border: 2px solid var(--primary-black); font-weight: 700; font-size: 0.85rem;">
                        ...
                        <div class="cause-content" style="padding: 1.75rem; flex: 1; display: flex; flex-direction: column;">
                            ...
                            <div class="cause-progress">
                                <div class="progress" style="height: 12px; background: #e9ecef; border: 2px solid var(--primary-black); border-radius: 0; margin-bottom: 1rem; overflow: hidden;">
            ...
            <nav aria-label="Causes pagination" style="margin-top: 3rem;">
                <ul class="pagination justify-content-center" style="gap: 0.5rem;">
                    <?php if ($page > 1): ?>
                    <li class="page-item">
                        <a class="page-link" href="causes.php?filter=<?php echo $filter; ?>&page=<?php echo $page - 1; ?>" style="border: 2px solid var(--primary-black); background: transparent; color: var(--primary-black); padding: 0.5rem 1rem; text-decoration: none;">
                    ...
                    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                        ...
                        <?php else: ?>
                        <li class="page-item">
                            <a class="page-link" href="causes.php?filter=<?php echo $filter; ?>&page=<?php echo $i; ?>" style="border: 2px solid var(--primary-black); background: transparent; color: var(--primary-black); padding: 0.5rem 1rem; text-decoration: none;">
                                <?php echo $i; ?>
                            </a>
                        </li>
                        <?php endif; ?>
...
<section style="padding: 80px 0; background: #f8f9fa;">
    <div class="container text-center">
        <h2 style="font-size: 2rem; font-weight: 700; margin-bottom: 1rem; color: var(--primary-black);">Every Contribution Counts</h2>
        ...
        <a href="get-involved.php#donate" class="btn" style="border: 2px solid var(--primary-black); background: var(--primary-black); color: #fff; padding: 1rem 2.5rem; font-weight: 700; text-decoration: none; display: inline-block; font-size: 1.1rem;">
