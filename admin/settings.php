 ...
 * Comprehensive settings for the entire ULFA website
 * 
 * @author ULFA Development Team
 * @version 2.0.0
 */
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="site_name" name="settings[site_name]" class="form-control"
                                value="<?php echo htmlspecialchars(s('site_name', 'United Love for All (ULFA)')); ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="site_short_name" name="settings[site_short_name]" class="form-control"
                                value="<?php echo htmlspecialchars(s('site_short_name', 'ULFA')); ?>"
                                placeholder="e.g., ULFA">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="site_tagline" name="settings[site_tagline]" class="form-control"
                                value="<?php echo htmlspecialchars(s('site_tagline', 'United Love for All')); ?>"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="whatsapp_default_message" name="settings[whatsapp_default_message]" class="form-control" rows="2"
                                placeholder="Hello, I would like to know more about ULFA."><?php echo htmlspecialchars(s('whatsapp_default_message', 'Hello, I would like to know more about ULFA.')); ?></textarea>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="meta_title" name="settings[meta_title]" class="form-control"
                                ...
                                placeholder="ULFA - United Love for All Orphanage Centre">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="meta_keywords" name="settings[meta_keywords]" class="form-control"
                                ...
                                placeholder="orphanage, charity, Uganda, children, ULFA">
