    ...
    if ($action === 'send_reply') {
        ...
        if (empty($replyMessage)) {
            ...
            if ($result) {
                ...
                $headers = "From: ULFA Charity <noreply@ulfacharity.org>\r\n";
                ...
                <body style='font-family: Arial, sans-serif; line-height: 1.6;'>
                    <div style='max-width: 600px; margin: 0 auto; padding: 20px;'>
                        <div style='background: #FFC107; padding: 20px; text-align: center;'>
                            <h1 style='margin: 0; color: #000;'>ULFA Charity</h1>
                        </div>
                        ...
                        <div style='padding: 15px; background: #000; color: #fff; text-align: center; font-size: 12px;'>
                            <p style='margin: 0;'>ULFA Charity - Transforming Lives Together</p>
                        </div>
                    </div>
                </body>
                </html>";
