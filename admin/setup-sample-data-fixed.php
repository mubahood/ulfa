<?php
/**
 * Setup Sample Data for ULFA Charity Website - Fixed Version
...
try {
    ...
    $newsArticles = [
        ['title' => 'ULFA Launches New Education Initiative for Underprivileged Children', 'category' => 'Education', 'days_ago' => 7],
        ['title' => 'Community Clean-Up Drive: 200 Volunteers Make a Difference', 'category' => 'Community', 'days_ago' => 5],
        ['title' => 'ULFA Distributes 1000 Food Packages to Families in Need', 'category' => 'Relief', 'days_ago' => 10],
        ...
        ['title' => 'ULFA Partners with Local Schools to Combat Childhood Malnutrition', 'category' => 'Education', 'days_ago' => 2],
    ...
    $newsContent = [
        ...
        '<p>In response to the growing food insecurity in our community, ULFA has ramped up its food distribution efforts. This month, we successfully distributed 1,000 food packages to families struggling to make ends meet. Each package contains essential items for a family of four for two weeks.</p>',
        '<p>Access to healthcare remains a significant challenge in rural areas. To address this, ULFA organized a comprehensive medical camp that served over 500 patients across three villages last weekend. A team of 25 doctors, nurses, and healthcare volunteers provided free consultations and distributed essential medicines.</p>',
        '<p>Today marks a significant milestone as ULFA celebrates the graduation of 50 women from our Skills Training and Employment Program. After three months of intensive training in tailoring, computer skills, and entrepreneurship, these women are ready to embark on new career paths.</p>',
        '<p>Recognizing that proper nutrition is fundamental to children\'s learning and development, ULFA has partnered with five local schools to provide nutritious meals to students from low-income families. The program ensures that 1,200 children receive at least one balanced meal each school day.</p>',
        '<p>Every young person deserves guidance and support. ULFA\'s new Youth Mentorship Program pairs at-risk youth aged 13-18 with successful professionals who serve as mentors and role models. The program focuses on personal development, academic support, career exploration, and life skills training.</p>',
        '<p>In response to the recent floods that displaced over 300 families, ULFA has launched an Emergency Relief Fund and mobilized our disaster response team. Within 48 hours, our team established relief camps, distributed emergency supplies, and began coordinating with local authorities.</p>'
    ];
    ...
    $eventsData = [
        [
            ...
            'description' => '<p>Join us for an elegant evening of dinner, entertainment, and fundraising to support ULFA\'s programs. This year\'s gala will feature live music, a silent auction, and inspiring stories from the communities we serve.</p><p>Dress code: Formal attire. Tickets include a three-course dinner, beverages, and entertainment.</p>',
        ...
        [
            ...
            'venue_name' => 'ULFA Community Center',
    ...
    $teamData = [
        ...
        [
            ...
            'bio' => 'Michael oversees all ULFA programs, ensuring quality implementation and maximum impact. With a Master\'s degree in Public Administration and 15 years of program management experience, he excels at coordinating complex initiatives.',
        ...
        [
            ...
            'department' => 'Administrative',
            'bio' => 'David ensures financial transparency and sustainability for ULFA. As a Certified Public Accountant with nonprofit finance expertise, he manages budgets, grants, and financial reporting with meticulous attention to detail.',
        ...
        [
            ...
            'department' => 'Management',
            'bio' => 'Robert oversees day-to-day operations, facilities management, and logistics for all ULFA programs and events. His military background brings discipline and efficiency to our operational processes.',
