...
try {
    ...
    foreach ($newsArticles as $index => $article) {
        ...
        $newsData = [
            ...
            'excerpt' => 'This is a sample news article about ' . $article['title'] . '. It provides important information about ULFA\'s charitable activities and community impact.',
    ...
    foreach ($events as $index => $event) {
        ...
        $eventData = [
            ...
            'description' => '<p>Join us for ' . $event['title'] . '. This is an important event that brings our community together to support ULFA\'s mission.</p><p>Registration and more details available on our website.</p>',
    ...
    foreach ($team as $index => $member) {
        ...
        $memberData = [
            ...
            'bio' => $member['name'] . ' is a dedicated member of the ULFA team, bringing expertise and passion to the ' . $member['position'] . ' role. With years of experience in nonprofit work, ' . explode(' ', $member['name'])[0] . ' helps drive our mission forward.',
            'photo' => $filename,
