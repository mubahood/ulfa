...
<section style="padding: 2rem 0; background: #f8f9fa; border-bottom: 2px solid var(--primary-black);">
    <div class="container">
        <div class="d-flex flex-wrap gap-2 justify-content-center">
            <a href="gallery.php" class="btn btn-sm" style="border: 2px solid var(--primary-black); background: <?php echo !$category ? 'var(--primary-yellow)' : 'transparent'; ?>; color: var(--primary-black); padding: 0.5rem 1.5rem; font-weight: 600; text-decoration: none;">
                All Albums
            </a>
            <?php foreach ($categories as $cat): ?>
            <a href="gallery.php?category=<?php echo urlencode($cat); ?>" class="btn btn-sm" style="border: 2px solid var(--primary-black); background: <?php echo $category === $cat ? 'var(--primary-yellow)' : 'transparent'; ?>; color: var(--primary-black); padding: 0.5rem 1.5rem; font-weight: 600; text-decoration: none;">
        ...
        <?php else: ?>
                        ...
                        <a href="gallery-album.php?id=<?php echo $album['id']; ?>" style="display: block; height: 100%; text-decoration: none;">
                            ...
                            <div class="album-overlay" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: linear-gradient(to top, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.5) 50%, rgba(0,0,0,0) 100%); display: flex; flex-direction: column; justify-content: flex-end; padding: 1.75rem;">
                                ...
                                <div style="display: flex; align-items: center; gap: 1rem; color: rgba(255,255,255,0.9); font-size: 0.9rem;">
                                    <span><i class="far fa-images" style="color: var(--primary-yellow);"></i> <?php echo $album['image_count']; ?> photos</span>
                                    <span><i class="far fa-calendar" style="color: var(--primary-yellow);"></i> <?php echo date('M d, Y', strtotime($album['created_at'])); ?></span>
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <nav aria-label="Gallery pagination" style="margin-top: 3rem;">
                <ul class="pagination justify-content-center" style="gap: 0.5rem;">
                    <?php if ($page > 1): ?>
                    <li class="page-item">
                        <a class="page-link" href="gallery.php?page=<?php echo $page - 1; ?><?php echo $category ? '&category=' . urlencode($category) : ''; ?>" style="border: 2px solid var(--primary-black); background: transparent; color: var(--primary-black); padding: 0.5rem 1rem; text-decoration: none;">
                    ...
                    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                        ...
                        <?php else: ?>
                        <li class="page-item">
                            <a class="page-link" href="gallery.php?page=<?php echo $i; ?><?php echo $category ? '&category=' . urlencode($category) : ''; ?>" style="border: 2px solid var(--primary-black); background: transparent; color: var(--primary-black); padding: 0.5rem 1rem; text-decoration: none;">
                                <?php echo $i; ?>
                            </a>
                        </li>
                        <?php endif; ?>
