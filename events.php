...
<section style="padding: 2rem 0; background: #f8f9fa; border-bottom: 2px solid var(--primary-black);">
    <div class="container">
        <div class="d-flex justify-content-center gap-3">
            <a href="events.php?filter=upcoming" class="btn" style="border: 2px solid var(--primary-black); background: <?php echo $filter === 'upcoming' ? 'var(--primary-yellow)' : 'transparent'; ?>; color: var(--primary-black); padding: 0.75rem 2rem; font-weight: 600; text-decoration: none;">
                <i class="far fa-calendar-plus me-2"></i> Upcoming Events
            </a>
            <a href="events.php?filter=past" class="btn" style="border: 2px solid var(--primary-black); background: <?php echo $filter === 'past' ? 'var(--primary-yellow)' : 'transparent'; ?>; color: var(--primary-black); padding: 0.75rem 2rem; font-weight: 600; text-decoration: none;">
        ...
        <?php else: ?>
                    ...
                    <div class="event-card" style="border: 2px solid var(--primary-black); border-radius: 0; overflow: hidden; height: 100%; display: flex; flex-direction: column; background: #fff; transition: transform 0.3s;">
                        ...
                        <div class="event-content" style="padding: 1.5rem; flex: 1; display: flex; flex-direction: column;">
                            <h3 style="font-size: 1.3rem; font-weight: 600; margin-bottom: 1rem; line-height: 1.4;">
                                <a href="event-detail.php?id=<?php echo $event['id']; ?>" style="color: var(--primary-black); text-decoration: none;">
                            ...
                            <a href="event-detail.php?id=<?php echo $event['id']; ?>" class="btn btn-sm" style="border: 2px solid var(--primary-black); background: var(--primary-yellow); color: var(--primary-black); padding: 0.65rem 1.75rem; align-self: flex-start; font-weight: 600; text-decoration: none;">
            ...
            <nav aria-label="Events pagination" style="margin-top: 3rem;">
                <ul class="pagination justify-content-center" style="gap: 0.5rem;">
                    <?php if ($page > 1): ?>
                    <li class="page-item">
                        <a class="page-link" href="events.php?filter=<?php echo $filter; ?>&page=<?php echo $page - 1; ?>" style="border: 2px solid var(--primary-black); background: transparent; color: var(--primary-black); padding: 0.5rem 1rem; text-decoration: none;">
                    ...
                    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                        ...
                        <?php else: ?>
                        <li class="page-item">
                            <a class="page-link" href="events.php?filter=<?php echo $filter; ?>&page=<?php echo $i; ?>" style="border: 2px solid var(--primary-black); background: transparent; color: var(--primary-black); padding: 0.5rem 1rem; text-decoration: none;">
                                <?php echo $i; ?>
                            </a>
                        </li>
                        <?php endif; ?>
