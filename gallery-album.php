    ...
    <div class="container">
        <div class="text-center">
            <div style="margin-bottom: 1rem;">
                <a href="gallery.php" style="color: var(--primary-yellow); text-decoration: none; font-weight: 600;">
        ...
        <?php else: ?>
            <div class="row g-3">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="gallery-image-card" onclick="openLightbox(<?php echo $index; ?>)" style="border: 2px solid var(--primary-black); border-radius: 0; overflow: hidden; cursor: pointer; position: relative; height: 280px; transition: transform 0.3s;">
...
<section style="padding: 80px 0; background: var(--primary-yellow);">
    <div class="container text-center">
        <h2 style="font-size: 2rem; font-weight: 700; margin-bottom: 1rem; color: var(--primary-black);">Explore More Albums</h2>
        <p style="font-size: 1.1rem; margin-bottom: 2rem; color: var(--primary-black);">
            See more photos from our activities and events
        </p>
        <a href="gallery.php" class="btn" style="border: 2px solid var(--primary-black); background: var(--primary-black); color: #fff; padding: 0.75rem 2rem; font-weight: 600; text-decoration: none;">
