...
$pageDescription = 'Support ULFA with your generous donation. Every contribution makes a difference.';
...
<div class="donation-page">
    <div class="donation-container">
        <div class="donation-header">
            <h1><i class="fas fa-heart" style="color: var(--primary-yellow);"></i> Make a Donation</h1>
