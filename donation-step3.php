            ...
            <?php elseif ($donation && $donation['payment_status'] === 'completed'): ?>
                ...
                <div class="share-section">
                    ...
                    <div class="share-buttons">
                        ...
                        <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('I just donated to ULFA to support orphaned children in Uganda! Join me: https://ulfa.org'); ?>" target="_blank" class="share-btn twitter">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a href="https://wa.me/?text=<?php echo urlencode('I just donated to ULFA to support orphaned children in Uganda! Join me: https://ulfa.org'); ?>" target="_blank" class="share-btn whatsapp">
